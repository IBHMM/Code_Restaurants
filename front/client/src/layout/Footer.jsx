...
const Footer = () => {
  return (
    <footer class="ftco-footer ftco-bg-dark ftco-section snipcss-KJXZL">
    <div class="container">
        <div class="row mb-5">
            <div class="col-md">
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <p> Copyright ©2024 All rights reserved | This template is made with <i class="icon-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a>
                </p>
            </div>
        </div>
    </div>
